...
def top_50_file_path(pr_score, file_path):
    ...
    pr_score_final_top_50 = torch.topk(pr_score_final, 50)
    file_path_top_50 = []
...
def top_100_purity_file_path(pr_score, file_path):
    ...
    if len(putity_score) < 100:
        return file_path
    putity_score_top_100 = torch.topk(putity_score, 100)
    file_path_top_100 = []
...
def top_50_info_file_path(pr_score, file_path):
    ...
    info_score_top_50 = torch.topk(info_score, 50)
    file_path_top_50 = []
