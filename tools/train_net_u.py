...
def register_from_path(dataset_name):
    ...
    if "U4" in dataset_name:
        json_add = "json/coco_4_k.json"
        base_dir_path = base_dir_path + "U4/"
    elif "U3" in dataset_name:
        json_add = "json/coco_5_k.json"
        base_dir_path = base_dir_path + "U3/"
    elif "U2" in dataset_name:
        json_add = "json/coco_6_k.json"
        base_dir_path = base_dir_path + "U2/"
        pass

    if "_aku_" in dataset_name:
        # 将json_add中的_k替换为_a
        json_add = json_add.replace("_k", "_a")
        pass
    ...
    elif "_338_" in dataset_name:
        mid_path = "coco_base_train_338/"
    elif "_138_" in dataset_name:
        mid_path = "coco_labeled_138/"
    elif "_158_" in dataset_name:
        mid_path = "coco_labeled_158/"
    elif "_178_" in dataset_name:
        mid_path = "coco_labeled_178/"
    elif "_198_" in dataset_name:
        mid_path = "coco_labeled_198/"
    elif "_218_" in dataset_name:
        mid_path = "coco_labeled_218/"
    elif "_238_" in dataset_name:
        mid_path = "coco_labeled_238/"
    elif "_258_" in dataset_name:
        mid_path = "coco_labeled_258/"
    elif "_278_" in dataset_name:
        mid_path = "coco_labeled_278/"
    elif "_298_" in dataset_name:
        mid_path = "coco_labeled_298/"
    elif "_318_" in dataset_name:
        mid_path = "coco_labeled_318/"
    elif "_20_" in dataset_name:
        mid_path = "coco_unlabeled_20/"
    elif "_40_" in dataset_name:
        mid_path = "coco_unlabeled_40/"
    elif "_60_" in dataset_name:
        mid_path = "coco_unlabeled_60/"
    elif "_80_" in dataset_name:
        mid_path = "coco_unlabeled_80/"
    elif "_100_" in dataset_name:
        mid_path = "coco_unlabeled_100/"
    elif "_120_" in dataset_name:
        mid_path = "coco_unlabeled_120/"
    elif "_140_" in dataset_name:
        mid_path = "coco_unlabeled_140/"
    elif "_160_" in dataset_name:
        mid_path = "coco_unlabeled_160/"
    elif "_180_" in dataset_name:
        mid_path = "coco_unlabeled_180/"
    elif "_200_" in dataset_name:
        mid_path = "coco_unlabeled_200/"
